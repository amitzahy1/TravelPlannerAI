import{g as _}from"./index-CSY3iacr.js";import"./framer-COmKckl1.js";import"./firebase-BJyaidjC.js";import"./map-C2wn3rKq.js";const m="travel_app_map_sanity_cache_v1",S=720*60*60*1e3,d=new Map,$=()=>{try{const e=localStorage.getItem(m);if(!e)return;const o=JSON.parse(e),n=Date.now();Object.entries(o).forEach(([a,r])=>{r&&r.result&&n-(r.ts||0)<S&&d.set(a,r.result)})}catch{}},A=()=>{try{const e={},o=Date.now();d.forEach((n,a)=>{e[a]={result:n,ts:o}}),localStorage.setItem(m,JSON.stringify(e))}catch{}};typeof window<"u"&&$();const g=(e,o)=>`${e.id}|${e.lat.toFixed(3)}|${e.lng.toFixed(3)}|${o.toLowerCase()}`,E=(e,o)=>`
