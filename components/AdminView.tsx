            ...
            <div className="w-full h-full md:max-w-6xl bg-white md:rounded-[2rem] shadow-2xl overflow-hidden flex flex-col md:flex-row animate-scale-in" onClick={(e) => e.stopPropagation()}>
                                    ...
                                    <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 h-full">
                                        <div className="flex justify-between items-center mb-6">
                                            ...
                                            <button
                                                ...
                                                className="text-xs font-bold bg-purple-50 text-purple-600 px-3 py-1.5 rounded-lg hover:bg-purple-100 transition-colors flex items-center gap-1 mr-2"
                                            >
                                                <Sparkles className="w-3 h-3" /> חיפוש חכם
                                            </button>
                                            <button
                ...
                {isSmartSearchOpen && (
                    <SmartHotelSearchModal
                        ...
                        onSave={(newHotel) => {
                            const newHotels = [...(activeTrip?.hotels || []), newHotel];
                            handleUpdateTrip({ hotels: newHotels });
