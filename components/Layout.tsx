...
import { Map, Plane, Utensils, Hotel, Globe, Ticket, ChevronDown, MapPin, Wallet, MessageCircle, X, Sparkles, ShieldCheck, ShoppingBag, Plus, Check, List } from 'lucide-react';
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <button
                  ...
                  className="flex flex-col items-center justify-center gap-2 bg-slate-100 text-slate-700 hover:bg-slate-200 p-4 rounded-2xl transition-all border border-slate-200"
                >
